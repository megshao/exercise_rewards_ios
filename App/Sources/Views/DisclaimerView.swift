...
struct DisclaimerView: View {
    ...
    private var dataSection: some View {
        section(
            ...
            bullet("開發者**沒有任何伺服器**，收不到也看不到你的身分證號、生日與手機號碼。")
            bullet("這三個欄位加密保存在**這支手機**（iOS Keychain），不同步 iCloud、不隨備份轉移，可隨時在「我的資料」一鍵永久刪除。")
            bullet("你按下登入時，資料由**這支手機直接送到官方網站**，中間不經過開發者或任何其他服務。")
            bullet("為了修 bug，App 會把**匿名的操作紀錄與當機報告**送給 Google Firebase：看了哪個畫面、哪一步失敗、當機在哪。**裡面沒有你的個資**，也沒有你上傳的截圖與券碼。不想送可以到「我的資料 › 安全與隱私」關掉。")
        }
    }
