...
| 欄位 | 建議 | 理由 |
|---|---|---|
| 主要類別 | **健康與健身（Health & Fitness）** | 核心情境仍是運動任務與獎勵（每期上傳運動紀錄、換取加碼券）。**注意**：移除 HealthKit 之後，這個類別不再有「使用 HealthKit」這個理由支撐，若審查時被質疑，改填**工具（Utilities）**或**生活風格（Lifestyle）**都說得通——送審前請重新確認一次。 |
